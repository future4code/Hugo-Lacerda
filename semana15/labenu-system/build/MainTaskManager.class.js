...
const InstructorsRoll_class_1 = require("./InstructorsRoll.class");
const MissionsRoll_class_1 = require("./MissionsRoll.class");
class MainTaskManager {
    constructor() {
        this.execute = () => {
            ...
            const studentsTxtFM = new FileManager_class_1.default("students.txt");
            const instructorsTxtFM = new FileManager_class_1.default("instructors.txt");
            const missionsTxtFM = new FileManager_class_1.default("missions.txt");
            studentsTxtFM.writeFile([
                student01,
                student02,
                student03,
                student04,
            ...
            missionsTxtFM.writeFile([missionA, missionB, missionC, missionD, missionE]);
            this.allStudents = new StudentsRoll_class_1.default(studentsTxtFM.readFile());
            this.allInstructors = new InstructorsRoll_class_1.default(instructorsTxtFM.readFile());
            this.allMissions = new MissionsRoll_class_1.default(missionsTxtFM.readFile());
            const someStudAge = this.allStudents.getStudentAge(9);
        };
        this.studentsLog = () => {
            this.execute();
            this.allMissions.studentsDataLog();
        };
        this.instructorsLog = () => {
            this.execute();
            this.allMissions.instructorsDataLog();
        };
    }
}
exports.default = MainTaskManager;
//# sourceMappingURL=MainTaskManager.class.js.map